...
- Hard pass: False
- Formal blockers: ['classifier_fixture_only', 'metric_hard_pass_failed', 'partner_gate_failed', 'semantic_engine_not_formal', 'topic_gate_failed']
- Pilot gate: True
- Split gate: True
...
- User delta median: 0.0022; IQR: 0.0137
- Pair-count distribution: {'2': 2, '5': 1, '8': 1, '10': 1, '17': 1, '19': 2, '20': 1, '25': 1, '26': 2}

| Strategy | mean P-A delta | positive | negative | median | IQR |
| --- | --- | --- | --- | --- | --- |
| `partner` | -0.0048 | 2 | 1 | 0.0033 | 0.0843 |
| `random` | 0.0149 | 3 | 0 | 0.0190 | 0.0156 |
| `temporal` | 0.0168 | 1 | 2 | -0.0015 | 0.0081 |
| `topic` | 0.0318 | 3 | 0 | 0.0223 | 0.0188 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `baseline_a` | 179 | 0.4804 | 0.7207 | 0.0000 | 0.0000 | 0.0000 | 0.0024 | 0.1412 | 0.0056 |
| `baseline_c` | 179 | 0.4972 | 0.7095 | 0.0000 | 0.0000 | 0.0000 | -0.0084 | 0.1412 | 0.0056 |
...
| --- | --- | --- | --- | --- | --- |
| `semantic_similarity` | 0.0729 | 0.0582 | 0.0147 | 0.3750 | False |
| `behavioral_similarity_strategy` | 0.4105 | 0.4413 | -0.0308 | 1.0000 | False |
| `behavioral_similarity_action11` | 0.1076 | 0.1951 | -0.0876 | 1.0000 | False |
| `stylistic_similarity` | 0.8788 | 0.8827 | -0.0039 | 1.0000 | False |
...
| --- | --- | --- | --- | --- | --- |
| `semantic_similarity` | 0.0729 | 0.0811 | -0.0083 | 1.0000 | False |
| `behavioral_similarity_strategy` | 0.4105 | 0.4413 | -0.0308 | 1.0000 | False |
| `behavioral_similarity_action11` | 0.1076 | 0.1951 | -0.0876 | 1.0000 | False |
| `stylistic_similarity` | 0.8788 | 0.8613 | 0.0175 | 0.1250 | False |
| `personality_similarity` | 1.0000 | 1.0000 | 0.0000 | 1.0000 | False |
| `agent_state_similarity` | 1.0000 | — | — | — | — |

## Hard metric rows (summary)
- `semantic_similarity`: personality=0.0729, baseline_a=0.0582, p(vs_a)=0.3750, baseline_c=0.0811, p(vs_c)=1.0000
- `agent_state_similarity`: personality=1.0000, baseline_a=—, p(vs_a)=—, baseline_c=—, p(vs_c)=—

## Soft Metrics
- `behavioral_similarity_strategy`: personality=0.4105, baseline_a=0.4413, baseline_c=0.4413
- `behavioral_similarity_action11`: personality=0.1076, baseline_a=0.1951, baseline_c=0.1951
- `stylistic_similarity`: personality=0.8788, baseline_a=0.8827, baseline_c=0.8613
