...
- Hard pass: False
- Formal blockers: ['behavioral_majority_baseline_matches_or_beats_personality', 'classifier_provisional_llm_labels', 'metric_hard_pass_failed', 'no_policy_ablation_failed', 'partner_gate_failed', 'semantic_vs_baseline_c_failed', 'surface_only_ablation_failed', 'topic_gate_failed']
- Pilot gate: True
- Split gate: True
